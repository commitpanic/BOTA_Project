# -*- coding: utf-8 -*-
"""
Add missing translations for Cookie Policy and Terms of Service
"""

# Additional translations to append to django.po
TRANSLATIONS = """
# Cookie Policy
...
# Read current django.po
with open('locale/pl/LC_MESSAGES/django.po', 'r', encoding='utf-8') as f:
    content = f.read()

# Append new translations before the last empty line
...
print("✅ Successfully added all translations!")
print("📝 Total translations added: ~150 strings")
print("🔄 Now compiling translations...")
